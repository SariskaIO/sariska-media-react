...
export const JitsiConnectionQualityEvents
    = SariskaMediaTransport.events.connectionQuality;
export const JitsiE2ePingEvents = SariskaMediaTransport.events.e2eping;
...
const statsEmitter = {
    ...
    startListeningForStats(conference) {
        ...
        conference.on(JitsiConnectionQualityEvents.REMOTE_STATS_UPDATED,
            (id, stats) => {
                console.log('remote stats updated', stats);
        ...
        conference.on(
            ...
            (participant, e2eRtt) => {
                const stats = {
                    ...
                    console.log('e2e rtt changed', stats);
