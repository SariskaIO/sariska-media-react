...
(function(ctx) {
    ...
    if (typeof ctx.SariskaMediaTransport === 'undefined') {
        ctx.SariskaMediaTransport = {};
    }
    if (typeof ctx.SariskaMediaTransport.app === 'undefined') {
        ctx.SariskaMediaTransport.app = {};
    }
    if (typeof ctx.SariskaMediaTransport.app.analyticsHandlers === 'undefined') {
        ctx.SariskaMediaTransport.app.analyticsHandlers = [];
    }
    ctx.SariskaMediaTransport.app.analyticsHandlers.push(Analytics);
})(window);
