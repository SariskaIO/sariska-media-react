...
import AbstractHandler from './AbstractHandler'; //import { fixDeviceID } from './amplitude';
...
export default class AmplitudeHandler extends AbstractHandler {
  ...
  constructor(options) {
    ...
    this._getInstance().init(amplitudeAPPKey, undefined, amplitudeOptions); //fixDeviceID(this._getInstance());
