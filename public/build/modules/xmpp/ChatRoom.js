...
export default class ChatRoom extends Listenable {
  ...
  onMessage(msg, from) {
    const nick = $(msg).find('>nick[xmlns="http://jabber.org/protocol/nick"]').text() || Strophe.getResourceFromJid(from);
  ...
  addAudioInfoToPresence(mute) {
    return this.addOrReplaceInPresence('audiomuted', {
      attributes: {
  ...
  addVideoInfoToPresence(mute) {
    return this.addOrReplaceInPresence('videomuted', {
      attributes: {
