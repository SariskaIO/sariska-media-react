...
/**
 * The sariska-media-transport browser-agnostic names of the browser-specific keys
...
export default function StatsCollector(peerconnection, audioLevelsInterval, statsInterval, eventEmitter) {
  ...
  this._usesPromiseGetStats = browser.isWebKitBased() || browser.isFirefox() || browser.isReactNative();
  /**
   * The function which is to be used to retrieve the value associated in a
   * report returned by RTCPeerConnection#getStats with a sariska-media-transport
 ...
 * associated with a sariska-media-transport browser-agnostic name.
 *
...
StatsCollector.prototype._defineGetStatValueMethod = function (keys) {
  // Define the function which converts a sariska-media-transport browser-asnostic name
  ...
  // associated with a specific sariska-media-transport browser-agnostic name.
...
StatsCollector.prototype.processStatsReport = function () {
  ...
  for (const idx in this.currentStatsReport) {
    ...
    let codec; // Try to get the codec for later reporting.
 ...
 * Defines a function which (1) is to be used as a StatsCollector method and (2)
 * gets the value from a specific report returned by RTCPeerConnection#getStats
 * associated with a sariska-media-transport browser-agnostic name in case of using
