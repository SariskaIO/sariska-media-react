...
export class ReceiveVideoController {
  ...
  constructor(conference, rtc) {
    ...
    this._rtc = rtc; // Translate the legacy bridge channel signaling format to the new format.

    this._receiverVideoConstraints = ((_conference$options = conference.options) === null || _conference$options === void 0 ? void 0 : (_conference$options$c = _conference$options.config) === null || _conference$options$c === void 0 ? void 0 : _conference$options$c.useNewBandwidthAllocationStrategy) ? new ReceiverVideoConstraints() : undefined; // The number of videos requested from the bridge, -1 represents unlimited or all available videos.
  ...
  selectEndpoints(ids) {
    ...
    if (this._receiverVideoConstraints) {
      const remoteEndpointIds = ids.filter(id => id !== this._conference.myUserId()); // Filter out the local endpointId from the list of selected endpoints.
