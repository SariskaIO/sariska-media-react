...
function createLocalTracks(tracksInfo, options) {
  ...
  tracksInfo.forEach(trackInfo => {
    ...
    const localTrack = new JitsiLocalTrack({ ...trackInfo,
      deviceId,
...
export default class RTC extends Listenable {
  ...
  static obtainAudioAndVideoPermissions(options) {
    ...
    const obtainMediaPromise = usesNewGumFlow ? RTCUtils.newObtainAudioAndVideoPermissions(options) : RTCUtils.obtainAudioAndVideoPermissions(options);
    ...
    this._channelOpenListener = () => {
      ...
      if (this._receiverVideoConstraints) {
        ...
        try {
          ...
          GlobalOnErrorHandler.callErrorHandler(error);
          logger.error(`Cannot send selected(${this._selectedEndpoint}), lastN(${this._lastN}),` + ` frameHeight(${this._maxFrameHeight}) endpoint message`, error);
        }
      }
