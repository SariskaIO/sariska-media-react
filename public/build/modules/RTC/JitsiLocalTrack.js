...
export default class JitsiLocalTrack extends JitsiTrack {
  ...
  _setMuted(muted) {
    ...
    if (this.isAudioTrack() || this.videoType === VideoType.DESKTOP || !browser.doesVideoMuteByStreamRemove()) {
      ...
      if (browser.usesNewGumFlow()) {
        promise = RTCUtils.newObtainAudioAndVideoPermissions(Object.assign({}, streamOptions, {
          constraints: {
      ...
      promise = promise.then(streamsInfo => {
        ...
        const streamInfo = browser.usesNewGumFlow() ? streamsInfo.find(info => info.track.kind === mediaType) : streamsInfo.find(info => info.mediaType === mediaType);
