...
/**
 * Implements browser capabilities for sariska-media-transport.
 */
...
export default class BrowserCapabilities extends BrowserDetection {
  ...
  supportsCodecPreferences() {
    return this.usesUnifiedPlan() && typeof window.RTCRtpTransceiver !== 'undefined' && Object.keys(window.RTCRtpTransceiver.prototype).indexOf('setCodecPreferences') > -1 && Object.keys(RTCRtpSender.prototype).indexOf('getCapabilities') > -1 // this is not working on Safari because of the following bug
