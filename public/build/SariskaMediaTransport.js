  ...
  */
  ...
  createLocalTracks(options = {}, oldfirePermissionPromptIsShownEvent, originalOptions) {
    ...
    return RTC.obtainAudioAndVideoPermissions(restOptions).then(tracks => {
      ...
      if (error.name === JitsiTrackErrors.UNSUPPORTED_RESOLUTION && !browser.usesNewGumFlow()) {
        ...
        if (newResolution !== null) {
          ...
          return this.createLocalTracks(restOptions, originalOptions || Object.assign({}, restOptions));
  ...
  isDeviceListAvailable() {
    logger.warn('This method is deprecated, use ' + 'SariskaMediaTransport.mediaDevices.isDeviceListAvailable instead');
  ...
  isDeviceChangeAvailable(deviceType) {
    logger.warn('This method is deprecated, use ' + 'SariskaMediaTransport.mediaDevices.isDeviceChangeAvailable instead');
  ...
  enumerateDevices(callback) {
    logger.warn('This method is deprecated, use ' + 'SariskaMediaTransport.mediaDevices.enumerateDevices instead');
